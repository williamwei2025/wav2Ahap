    ...
    var body: some View {
        NavigationView{
            VStack{
                Text("").padding()
                Button(action: {
                    self.playHapticSong(name: "Accel Brick1")
                }, label: {
                    SongCardView(songName: "Accel Brick1", albumPhotoURL: URL(string: "https://i.scdn.co/image/ab67616d00001e02269423eb6467e308c0fbce24")!, artistName: "Shawn Mendes")
